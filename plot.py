...
# Load the datasets
csv_files = ["./datasets/body_dimensions/chunk_0.0.csv", "./datasets/body_dimensions/chunk_1.0.csv", "./datasets/body_dimensions/chunk_2.0.csv", "./datasets/body_dimensions/chunk_3.0.csv"]
...
for i, csv_file in enumerate(csv_files):
    ...
    ax.scatter(x, y, z, color=colors[i], label='Data Points')

##########################################################
csv_file = "./datasets/body_dimensions/body_dimensions_predictions.csv"
data = pd.read_csv(csv_file)
